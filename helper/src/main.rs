...
use git2::{
    ConfigEntry, FetchOptions, RemoteCallbacks, Repository, SubmoduleUpdateOptions,
};
                    ...
                    let module = match module.open() {
                        ...
                        Err(e) => {
                            ...
                            if e.code() == git2::ErrorCode::NotFound {
                                ...
                                if let Err(e) = module.clone(Some(
                                    SubmoduleUpdateOptions::new().fetch(fo),
                                )) {
